...
my $tumor_dir="/home/proj/MDW_genomics/xu/bam/";
my $normal_dir="/home/proj/MDW_genomics/xu/bam/";
my $output_dir="/scratch/xu/MDV_project/mt2_results";
my $genome="/home/users/xu/bwa/genome.fa";
...
foreach my $num (3,6,11,20..25){
	...
	print "$cmd\n";
	`qsub -b y -q all.q -l vf=36G,core=1  -N "mt2$sample" "$cmd"`;
